...
public class DescargasCARD {
   ...
   // private BigDecimal cobroSir; // money → BigDecimal
    ...
    // --- Relación ManyToOne con TblDescargasAVL ---
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "id_DGPRS", insertable = false, updatable = false)
    private DescargasAVL descargaAVL;
}
